...
namespace project2_hethonglaptop.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-LG42FLRB\\SQLEXPRESS;Database=Project2_hthonglaptopvaphukienmaytinh;User Id=sa;Password=1234;TrustServerCertificate=True;MultipleActiveResultSets=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HoaDon>(entity =>
        {
            ...
            entity.HasOne(d => d.MaNvNavigation).WithMany(p => p.HoaDons)
                ...
                .HasConstraintName("FK__HoaDon__MaNV__571DF1D5");
        });
        ...
        modelBuilder.Entity<Laptop>(entity =>
        {
            ...
            entity.HasOne(d => d.MaSpNavigation).WithOne(p => p.Laptop)
                ...
                .HasConstraintName("FK__Laptop__MaSP__4F7CD00D");
        });
        ...
        modelBuilder.Entity<SanPham>(entity =>
        {
            ...
            entity.HasOne(d => d.MaThNavigation).WithMany(p => p.SanPhams)
                ...
                .HasConstraintName("FK__SanPham__MaTH__4CA06362");
        });
